...
void DrawSamusSpritemapVerticallyFlipped(uint16 a, uint16 k, uint16 j);
void DrawSamusSpritemapVerticallyFlippedWithBounds(uint16 a, uint16 k, uint16 j, int16 mirror_top, int16 mirror_bottom);
void DrawSamusSpritemapRotatedWithBounds(uint16 a, uint16 k, uint16 j, int rotation_degrees, int16 left, int16 top, int16 right, int16 bottom);
